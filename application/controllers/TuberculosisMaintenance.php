...
class TuberculosisMaintenance extends CI_Controller
{
    ...
    private $table = "schedule_tuberculosis_maintenance";
    private $controllerName = "TuberculosisMaintenance";
    private $title = "TUBERCULOSIS MAINTENANCE";
    ...
    public function index()
    {
        ...
        $this->load->view('tuberculosisMaintenance', $data);
