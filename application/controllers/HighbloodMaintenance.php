...
class HighbloodMaintenance extends CI_Controller
{
    ...
    private $table = "schedule_highblood_maintenance";
    private $controllerName = "HighbloodMaintenance";
    private $title = "HIGHBLOOD MAINTENANCE";
    ...
    public function index()
    {
        ...
        $this->load->view('highbloodMaintenance', $data);
