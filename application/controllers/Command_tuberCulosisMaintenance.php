...
class Command_tuberCulosisMaintenance extends CI_Controller
{
    public $authKey;
    ...
    {	
        ...
        $result = $this->Main_model->_insert('schedule_tuberculosis_maintenance', $insert);
        return $result;
    }
    ...
    public function update()
    {
        ...
        $this->Main_model->_update("schedule_tuberculosis_maintenance", "id", $id, $update);
    }
    ...
    public function delete()
    {
        ...
        $this->Main_model->_delete("schedule_tuberculosis_maintenance", "id", $id);
    }
}
