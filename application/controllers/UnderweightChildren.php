...
class UnderweightChildren extends CI_Controller
{
    ...
    private $table = "schedule_underweight_children";
    private $controllerName = "UnderweightChildren";
    private $title = "MONITORING OF UNDERWEIGHT CHILDREN";
    ...
    public function index()
    {
        ...
        $this->load->view('underweightChildren', $data);
