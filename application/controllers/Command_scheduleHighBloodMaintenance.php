...
class Command_scheduleHighBloodMaintenance extends CI_Controller
{
    public $authKey;
    ...
    {	
        ...
        $result = $this->Main_model->_insert('schedule_pregnant_immunization', $insert);
        return $result;
    }
    ...
    public function update()
    {
        ...
        $this->Main_model->_update("schedule_pregnant_immunization", "id", $id, $update);
    }
    ...
    public function delete()
    {
        ...
        $this->Main_model->_delete("schedule_pregnant_immunization", "id", $id);
    }
}
