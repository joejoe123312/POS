...
<div id="base">
	...
	<div id="content">
		<section>
			<div class="section-body">
						...
						<div class="card">
							<div class="card-body no-padding">
								<div class="alert alert-callout alert-success no-margin">
									...
									<span class="opacity-50">Stock items inside inventory</span>
								</div>
							</div>
							<!--end .card-body -->
						</div>
						...
						<div class="card">
							<div class="card-body no-padding">
								<div class="alert alert-callout alert-success no-margin">
									...
									<span class="opacity-50">Number of sold items</span>
								</div>
							</div>
							<!--end .card-body -->
						</div>
				...
				<div class="bg-primary" id="searchResult" style="padding: 20px;;">
					<h1>Search results</h1>

					<h4>Name: <strong style="color: blue">Coke</strong></h4>
					<h4>SRP: <strong style="color: blue">Coke</strong></h4>
					<h4>Mark UP: <strong style="color: blue">Coke</strong></h4>
					<h4>Quantity: <strong style="color: blue">Coke</strong></h4>

					<button class="btn col-md-12" style="color: black; background-color: gold; font-weight: bold;">Sold</button>
				</div>
			</div>
			<!--end .section-body -->
		</section>
	...
	<script>
		// AUTOCOMPLETE SCRIPT 
		$(document).ready(function() {
			$.post("<?= base_url() ?>Dashboard/getAllItems", function(resp) {
